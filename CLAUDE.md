...
- NEVER use emojis anywhere — not in code, comments, commit messages, chat responses, markdown docs, UI strings, log messages, or any user-facing or internal text. If existing code contains emojis, remove or replace them with plain text when editing that area.
